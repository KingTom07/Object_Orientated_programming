...
class Main
{
  ...
  {//todo music playing thing
    playMusic("musicforcode2.wav");
    new Main().begin();
  }
  ...
  public void startCustomerGUI_MVC(MiddleFactory mlf )
  {
    ...
    window.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE); //only closes on yes.
    ...
    }); // todo adds event listener that checks when the window closes
    // todo gives the user a yes or no if they want to close the window
    //todo
    window.setTitle( "Customer Client MVC");
    window.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
    window.getContentPane().setBackground(Color.DARK_GRAY); //changes window colour to blue
